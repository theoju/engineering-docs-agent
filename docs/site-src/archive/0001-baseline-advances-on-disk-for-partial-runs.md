...
- [Glossary](../architecture/glossary.md) — precise definitions for the terms
  this record depends on: window, baseline, cursor, window head, promotion,
  ephemeral advance, admission gate, deferral, held back, and partial run.
  Mirrors `CONTEXT.md`, the repo's own domain-vocabulary reference.
