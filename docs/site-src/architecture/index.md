...
source_files:
  ...
  - docs/site-src/architecture/lint-rules.md
  - docs/site-src/architecture/bootstrap-fail-fast.md
...
- **Generator-aware frontmatter on the incremental create path** — Every nightly `docs-agent-nightly` run was completing without a time-budget
