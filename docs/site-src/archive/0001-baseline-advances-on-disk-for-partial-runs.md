...
- [Glossary](../architecture/glossary.md) — precise definitions for the terms
  this record leans on without re-explaining: promotion, ephemeral advance,
  held back, partial run, and deferral. It mirrors `CONTEXT.md`, the repo's
  own domain-vocabulary reference.
