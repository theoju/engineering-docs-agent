...
- **Time-budget enforcement now covers the authoring fan-out (CCE-114)** — CCE-109 gave the nightly orchestrator a soft deadline, but the check only
