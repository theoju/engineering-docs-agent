...
- [Glossary](../architecture/glossary.md) — defines the vocabulary this
  record assumes: window, baseline, cursor, ephemeral advance, deferral,
  held back, and partial run.
