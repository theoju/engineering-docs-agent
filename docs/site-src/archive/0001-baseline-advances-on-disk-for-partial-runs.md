...
- [Domain glossary](../architecture/glossary.md) — defines the terms this
  record leans on without re-explaining them: window, baseline, cursor,
  ephemeral advance, admission gate, deferral, held back, partial run, and
  promotion.
