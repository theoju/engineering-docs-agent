...
- **CCE-114: the time budget now bounds the authoring fan-out, not just PR admission** — Six consecutive scheduled nightlies (2026-06-05 through 2026-06-10) hit the workflow's 60-minute hard kill mid page-author fan-out, discarding an hour of Opus dispatches each time with no PR opened and no baseline advance — CCE-114 closes that gap by checking the soft deadline inside the authoring, fact-checker, and gap-detector loops, not only at PR admission.
